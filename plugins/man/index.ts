...
export function install(editor: Editor, ctx: PluginContext = createPluginContext(editor)): void {
  ...
  keymap.bind("enter", "man-follow")
  keymap.bind("return", "man-follow")
  keymap.bind("RET", "man-follow")
  keymap.bind("g", "Man-update-manpage")
  defineMode({
    name: "Man-mode",
    parent: "text",
    keymap,
  ...
  ctx.command("man-follow", async ({ editor, buffer }) => {
  ...
  ctx.command("Man-update-manpage", async ({ editor, buffer }) => {
