...
export class Evaluator {
  ...
  async evalForm(form: string, filename: string): Promise<unknown> {
    ...
    const code = stripped.trimStart().startsWith("editor.")
      ...
      || stripped.includes("customSetVariables(")
      || stripped.includes("customSetFaces(")
      || stripped.includes("customSetIcons(")
      || stripped.includes("defgroup(")
      || stripped.includes("defineIcon(")
